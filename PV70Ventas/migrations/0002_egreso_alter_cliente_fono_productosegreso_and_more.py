    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('egreso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PV70Ventas.egreso')),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PV70Ventas.producto')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='egreso',
            name='cliente',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='clientee', to='PV70Ventas.cliente'),
        ),
